...
const Header = () => {
    const { value, setValue, inputValue, setInputValue } = useContext(InputContext)
    ...
    return (
        <div className="bg-gray-700">
            <div className="container mx-auto py-8">
                ...
                <p className="text-center mt-1 mb-10 text-slate-300 text-lg">Find the definition for word</p>
